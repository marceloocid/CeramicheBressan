    ...
    <section className="bg-ceramica px-4 py-16 text-white sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-8 md:flex-row md:items-center">
        <div className="max-w-3xl">
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#ead7a4]">Contatto diretto</p>
          <h2 className="mt-3 font-serif text-3xl font-semibold leading-tight sm:text-4xl">
            Cerchi un prodotto in ceramica artigianale?
          </h2>
          <p className="mt-4 text-lg leading-8 text-[#f9f0e4]">
            Contattaci per informazioni, disponibilita o per organizzare una visita al laboratorio.
          </p>
        </div>
